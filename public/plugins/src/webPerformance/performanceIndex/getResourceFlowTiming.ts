<<<<<<< HEAD:packages/plugins/webPerformance/performanceIndex/getResourceFlowTiming.ts
import { disconnect, observe, ObserveHandler } from 'core/index';
import { Uploader, ErrorHandler } from 'types/index';
=======
>>>>>>> refactor-monorepo:public/plugins/src/webPerformance/performanceIndex/getResourceFlowTiming.ts
import {
